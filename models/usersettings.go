...
type CustomStatus struct {
	...
	ExpiresAt *int    `json:"expires_at" gorm:"type:bigint"` // is this the right type?
}
...
type GuildFolder struct {
	...
	GuildIDs string `json:"guild_ids" gorm:"type:json;not null;default:'[]'"`
}

type UserSettings struct {
	ID                                string             `json:"-" gorm:"primaryKey;unique"`
	ActivityJoiningRestrictedGuildIDs string             `json:"activity_joining_restricted_guild_ids" gorm:"type:json;not null;default:'[]'"`
	ActivityRestrictedGuildIDs        string             `json:"activity_restricted_guild_ids" gorm:"type:json;not null;default:'[]'"`
	...
	CustomStatus                      *CustomStatus      `json:"custom_status" gorm:"type:json"` // is this type correct?
	...
	FriendSourceFlags                 *FriendSourceFlags `json:"friend_source_flags" gorm:"type:json"`
	GifAutoPlay                       bool               `json:"gif_auto_play" gorm:"type:bool;not null;default:true"`
	GuildFolders                      []GuildFolder      `json:"guild_folders" gorm:"type:json"`
	...
	RestrictedGuilds                  string             `json:"restricted_guilds" gorm:"type:json;not null;default:'[]'"`
